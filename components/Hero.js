...
const Hero = ({ lang = 'en' }) => {
  ...
  return (
    ...
    >
      ...
      {/* Banner */}
      <img src="/Aya-Banner.png" alt="Aya-Yasmine Belloum Banner" className="mx-auto max-w-full h-auto" style={{ maxHeight: '220px', marginBottom: '200px' }} />

      {/* Bottom icons reordered: About, Education, Experience, Projects, Tech Stack, Skills, Interests, Languages, Contact */}
      <div className={`flex justify-center gap-8 mt-8 bg-white/90 rounded-lg py-3 px-4 shadow-lg ${isRTL ? 'flex-row-reverse' : ''}`}>
        <div className="flex flex-col items-center">
          <Icon icon="mdi:account" width="28" height="28" />
          <span className="text-xs font-quicksand mt-1">About Me</span>
        </div>
        <div className="flex flex-col items-center">
          <Icon icon="mdi:school" width="28" height="28" />
          <span className="text-xs font-quicksand mt-1">Education</span>
        </div>
        <div className="flex flex-col items-center">
          <Icon icon="mdi:briefcase" width="28" height="28" />
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-xs font-quicksand mt-1">Interests</span>
        </div>
        <div className="flex flex-col items-center">
          <Icon icon="mdi:translate" width="28" height="28" />
          <span className="text-xs font-quicksand mt-1">Languages</span>
        </div>
        <div className="flex flex-col items-center">
